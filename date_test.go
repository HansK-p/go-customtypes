...
`
	...
	if custom_1.Sub(custom_2).Seconds() != 3600*23 {
		t.Errorf("There isn't 3600*23 seconds difference as expected between dates, %s - %s = %f", custom_1, custom_2, custom_1.Sub(custom_2).Seconds())
	}
}
